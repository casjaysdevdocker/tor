...
# set data directory
DATA_DIR="/data/tor/bridge"
# set config directory
CONF_DIR="/config/tor/bridge"
# - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - -
# set the temp dir
TMP_DIR="/tmp/tor/bridge"
# set scripts pid dir
RUN_DIR="/run/tor/bridge"
# set log directory
...
# command to execute
EXEC_CMD_BIN='tor-bridge'
# command arguments
EXEC_CMD_ARGS='-f $CONF_DIR/bridge.conf'
...
TOR_BRIDGE_PT_PORT="${TOR_BRIDGE_PT_PORT:-57003}"
TOR_BRIDGE_OR_PORT="${TOR_BRIDGE_OR_PORT:-57004}"
TOR_BRIDGE_NICK_NAME="${TOR_BRIDGE_NICK_NAME:-}"
TOR_BRIDGE_ADMIN="${TOR_BRIDGE_ADMIN:-}"
TOR_BRIDGE_TOTAL_BANDWIDTH="${TOR_BRIDGE_TOTAL_BANDWIDTH:-250 GBytes}"
...
__post_execute() {
	...
	(
		...
		# commands to execute
		sleep 5
		if [ -f "/data/tor/bridge/fingerprint" ]; then
			cat "/data/tor/bridge/fingerprint"
		fi
		# show exit message
