...
if [ -n "$TOR_EXIT_ENABLED" ]; then
  if [ "$TOR_EXIT_ENABLED" != "yes" ]; then
...
# set data directory
DATA_DIR="/data/tor/exit"
# set config directory
CONF_DIR="/config/tor/exit"
# - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='tor-exit'
# command arguments
EXEC_CMD_ARGS='-f $CONF_DIR/exit.conf'
